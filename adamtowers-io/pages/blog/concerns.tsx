    ...
    <SingleColumn title={title} footer>
      <Article footnotes>
        <>
          ...
          <section>
            <ArticlePara>
              As an active practitioner of computer science (read as: someone
              too young to have any authority on the matter but you'll continue
              reading anyway), I've heard the adage "separation of concerns" too
              many times to have never found a trail guide to identifying
              concerns in the wild and separating them when appropriate. So
          ...
          <section>
            ...
            <ArticlePara>
              To think about concerns you need to role-play. Put on the hat of
              the chunk of code, module, or system you are currently concerned
              about (no pun intended) and see the world only as it perceives it.
              Think about every function it calls, module it depends on, or
              system it messages.
            </ArticlePara>
            <ArticlePara>
              ...
              ceases to exist? What if the module you depend on or the system
              you message change similarly? Probably you're going to break. And
              also probably: they won't consult you before doing that.
            </ArticlePara>
            <ArticlePara>
              Initially, I'd say a concern is "code that if it were to break
              would make you sad".
            </ArticlePara>
            <ArticlePara>
            ...
            <ArticlePara>
              ...
              you use", both internal to the module in question and outside of
              it.
            </ArticlePara>
            <ArticlePara>
              ...
              much as the idea itself. There's multiple levels:
            </ArticlePara>
            <ul>
              <li>
                Easy: bug in code <br />
          ...
          <section>
            ...
            <ArticlePara>
              So far we've stayed fairly abstract to concepts which can be
              applied to many kinds of systems, now let's speak specifically
              about software. When thinking about software systems we have a few
              kinds of concepts that immediately come to mind. Listed below in
              order of growing concern:
            </ArticlePara>
            <ul>
          ...
          <section>
            ...
            <ArticlePara>
              ...
              <ArticleFootnote symbol="1">
                I'd expect almost any concern that can be suffeciently seperated
                from not one but many technology businesses to be a successful
                company.
              </ArticleFootnote>
            </ArticlePara>
            <ArticlePara>
          ...
          <section>
            <h2>Concerns all the way down</h2>
            <ArticlePara>
